# -*- coding: utf-8 -*-
"""PollingNeuralNetworkAdam.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YaVm_iOcookcNlFUOxhjHe3ndllKbbfG
"""
...
def main_script(alpha1, alpha2, alpha3, epochs, history_toggle):
    ...
    for i in range(epochs):
        # Randomised testing
        W1_1, b1_1, W2_1, b2_1, m_dw_tentative1, m_db_tentative1, v_dw_tentative1, v_db_tentative1, m_dw_2_tentative1, m_db_2_tentative1, v_dw_2_tentative1, v_db_2_tentative1 = update_params(W1, b1, W2, b2, dW1, db1, dW2, db2, alpha1, m_dw, v_dw, m_db, v_db, m_dw_2, v_dw_2, m_db_2, v_db_2, beta1, beta2, epsilon, t)
        W1_2, b1_2, W2_2, b2_2, m_dw_tentative2, m_db_tentative2, v_dw_tentative2, v_db_tentative2, m_dw_2_tentative2, m_db_2_tentative2, v_dw_2_tentative2, v_db_2_tentative2 = update_params(W1, b1, W2, b2, dW1, db1, dW2, db2, alpha2, m_dw, v_dw, m_db, v_db, m_dw_2, v_dw_2, m_db_2, v_db_2, beta1, beta2, epsilon, t)
        W1_3, b1_3, W2_3, b2_3, m_dw_tentative3, m_db_tentative3, v_dw_tentative3, v_db_tentative3, m_dw_2_tentative3, m_db_2_tentative3, v_dw_2_tentative3, v_db_2_tentative3 = update_params(W1, b1, W2, b2, dW1, db1, dW2, db2, alpha3, m_dw, v_dw, m_db, v_db, m_dw_2, v_dw_2, m_db_2, v_db_2, beta1, beta2, epsilon, t)
        Z1_1, A1_1, Z2_1, A2_1 = forward_propagation(W1_1, b1_1, W2_1, b2_1, X_Y_axis_train)
        Z1_2, A1_2, Z2_2, A2_2 = forward_propagation(W1_2, b1_2, W2_2, b2_2, X_Y_axis_train)
        Z1_3, A1_3, Z2_3, A2_3 = forward_propagation(W1_3, b1_3, W2_3, b2_3, X_Y_axis_train)
        ...
        if ((prediction_choice_1 > prediction_choice_2) and (prediction_choice_1 > prediction_choice_3)):
            ...
            Z2 = Z2_1
            A2 = A2_1
            m_dw = m_dw_tentative1
            m_db = m_db_tentative1
            v_dw = v_dw_tentative1
            v_db = v_db_tentative1
            m_dw_2 = m_dw_2_tentative1
            m_db_2 = m_db_2_tentative1
            v_dw_2 = v_dw_2_tentative1
            v_db_2 = v_db_2_tentative1
            ...
            Z2 = Z2_2
            A2 = A2_2
            m_dw = m_dw_tentative2
            m_db = m_db_tentative2
            v_dw = v_dw_tentative2
            v_db = v_db_tentative2
            m_dw_2 = m_dw_2_tentative2
            m_db_2 = m_db_2_tentative2
            v_dw_2 = v_dw_2_tentative2
            v_db_2 = v_db_2_tentative2
            ...
            Z2 = Z2_3
            A2 = A2_3
            m_dw = m_dw_tentative3
            m_db = m_db_tentative3
            v_dw = v_dw_tentative3
            v_db = v_db_tentative3
            m_dw_2 = m_dw_2_tentative3
            m_db_2 = m_db_2_tentative3
            v_dw_2 = v_dw_2_tentative3
            v_db_2 = v_db_2_tentative3
        else:
    ...
    if history_toggle == 1:
        plt.plot(history)
        plt.title("Polling Neural Network with ADAM Optimiser, Epoch:100")
