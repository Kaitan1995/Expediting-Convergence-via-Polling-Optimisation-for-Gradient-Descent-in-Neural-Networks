# -*- coding: utf-8 -*-
"""FINAL_CNN_ADAM_SGD_TRAIN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YzuuimrSib7QnEgLQC7ZScabO4JSs1Ik
"""
...
def train(num_classes = 10, beta1 = 0.95, beta2 = 0.99, img_dim = 28, img_depth = 1, f = 5, num_filt1 = 8, num_filt2 = 8, batch_size = 32, num_epochs = 5, save_path = 'params.pkl'):
    ...
    processed_data_train = processed_data[500:m].T
...
plt.title("CNN (SGD, ADAM) Loss, Epoch: 5")
plt.xlabel('Passes')
plt.ylabel('Loss')
plt.legend()
plt.show()
...
plt.xlabel('Digits')
plt.ylabel('Recall')
plt.title("CNN (SGD, ADAM) Recall on Test Set, Epoch: 2")
